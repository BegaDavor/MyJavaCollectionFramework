...
public class BegaMap<K, V> implements Map<K, V> {
	...
	public Set<Entry<K, V>> entrySet() {
		BegaSet<Entry<K, V>> pairSet = new BegaSet<>();
	...
	public Set<K> keySet() {
		// TODO Auto-generated method stub
		BegaSet<K> setOfKeys = new BegaSet<>();
	...
	public void putAll(Map<? extends K, ? extends V> m) {
		// TODO Auto-generated method stub
		BegaSet<K> keysS = (BegaSet<K>) m.keySet();
		BegaSet<V> valuesS = (BegaSet<V>) m.values();
	...
	public Collection<V> values() {
		// TODO Auto-generated method stub
		BegaList<V> valuesList = new BegaList<>();
